...
function editor1() {
    ...
    var js_editor = CodeMirror(document.getElementById("display1.1"), {
        value: "var account = Account.NewAccount() \n" + "\n\t account.getAddressString()\n" + "\t account.getPublicString()\n" + "\t account.getPrivateString()",
        mode: "javascript",
        theme: "dracula",
        lineNumbers: true,
        lineWrapping: true,
...
function editor2() {
    ...
    var js_editor = CodeMirror(document.getElementById("display2.1"), {
        value: "var email = Math.random()" +" + "+ "test@demo.io\n" + "var request = new window.XMLHttpRequest()\n" + "var url = https://testnet.nebulas.io/claim/api/claim/" + " + " + "email" + " + " + "/" + "account.getAddressString()" + "/\n" + "request.open(\"GET\", url, true)\n"+ "request.onload = function (e) {\n" +
...
function editor4() {
    ...
    var js_editor = CodeMirror(document.getElementById("display4.1"), {
        value: " var resp = neb.api.sendRawTransaction(tx.toProtoString());\n" + " txhash = resp.txhash;\n",
        mode: "javascript",
        theme: "dracula",
        lineNumbers: true,
        lineWrapping: true,
...
function editor5() {
    ...
    var js_editor = CodeMirror(document.getElementById("display5.1"), {
        value: "neb.api.getTransactionReceipt(txhash, function (err, resp) {\n" + "});\n" + "}" ,
        mode: "javascript",
        theme: "dracula",
        lineNumbers: true,
        lineWrapping: true,
